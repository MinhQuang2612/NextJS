        ...
        const fetchData = async () => {
            try {
                ...
                const query = new URLSearchParams({
                    ...
                    ...(searchTerm ? { "filter[content]": searchTerm } : {}),
                                ...
                                <div className="flex flex-wrap gap-2 lg:gap-5">
                                    <div className="flex">
                                        <label className="input input-sm">
                                            ...
                                            <input placeholder="Tìm theo nội dung" type="text" style={{ width: "220px" }} value={searchTerm}
                                    ...
                                    <div className="flex">
                                            ...
                                            <select className="select select-sm w-40" value={filterBrand}
                                                onChange={(e) => handleBrandChange(e.target.value)}>
                                                <option value="">
                                                    Chọn Brandname
                                                </option>
                                                {templateData.map((template, index) => (
                                                    <option key={index} value={template.brand.name}>
                                                        {template.brand.name}
                                                    </option>
                                                ))}
                                            </select>
                                        ...
                                        <table className="table table-auto table-border w-full" data-datatable-table="true">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="min-w-[150px]">
                                                        <span
                                                            className={`sort ${sortConfig.key === 'brand.name'
                                                                ? (sortConfig.direction === 'asc' ? 'asc' : 'desc')
                                                                : ''
                                                                }`}
